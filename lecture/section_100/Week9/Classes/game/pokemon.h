...
// Header guards
// These header guards prevent the duplication of variables and functions when this header file
// gets imported in multiple other files
#ifndef POKEMON_H
#define POKEMON_H
...
class Pokemon {
    ...
    public:
        ...
        Pokemon(string name, int id, string type, int attack);
